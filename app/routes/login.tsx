...
const schema = v.object({
    ...
    password: v.pipe(v.string(), v.minLength(8, "Senha deve ter pelo menos 8 caracteres")),
});
...
export async function action({ request }: Route.ActionArgs) {
    ...
    const validated = parseWithValibot(formData, { schema });
            ...
            <div className="max-w-md w-full space-y-8">
                ...
                <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-gray-600">
                        Acesse sua conta para explorar cervejarias incríveis
                    </p>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-lg p-8">
                    <fetcher.Form {...getFormProps(form)} method="POST" className="space-y-6">
                        <div>
                            ...
                            />
                            {email.errors && (
                                <div className="mt-2 text-sm text-red-600">{email.errors.join(", ")}</div>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            />
                            {password.errors && (
                                <div className="mt-2 text-sm text-red-600">{password.errors.join(", ")}</div>
                            )}
                        </div>
                        ...
                        >
                            <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                                {!isSubmitting ? (
                                    <svg className="h-5 w-5 text-blue-500 group-hover:text-blue-400 animate-spin" fill="none" viewBox="0 0 24 24">
